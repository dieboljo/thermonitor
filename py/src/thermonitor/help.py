...
class HelpState(State):
    ...
    def _any_cell() -> RenderableType:
        ...
        table.add_row()
        table.add_row(Align.left("DASHBOARD"))
    ...
    def _edit_cell() -> RenderableType:
        ...
        table.add_column()
        table.add_column()
        table.add_row(Align.right('n'), ':', "add a new sensor")
        table.add_row(Align.right('r'), ':', "delete the selected sensor")
        table.add_row(Align.right('c'), ':', "rename the selected sensor")
    ...
    def _normal_cell() -> RenderableType:
        ...
        table.add_row(Align.right('p'), ':', "save current layout")
